...
/**
 * 直接运行此类即可生成增量包。位置在G:\PatchPackage，
 * 运行前需要自己定义下面6个静态变量
 * @author Administrator
 *
 */
public class FreePatchUtils {


    public static String patchFile="C:\\Users\\Administrator\\Workspaces\\MyEclipse Professional2014\\myDemo\\patch.txt";//补丁文件,由eclipse svn plugin生成

    public static String projectPath="C:\\Users\\Administrator\\Workspaces\\MyEclipse Professional 2014\\myDemo";//项目文件夹路径

    public static String webContent="WebRoot";//web应用文件夹名

    public static String classPath="C:\\Users\\Administrator\\Workspaces\\MyEclipse Professional 2014\\myDemo\\WebRoot\\WEB-INF\\classes";//class存放路径

    public static String desPath="G:\\PatchPackage";//补丁文件包存放路径

    public static String version="20181215";//补丁版本
